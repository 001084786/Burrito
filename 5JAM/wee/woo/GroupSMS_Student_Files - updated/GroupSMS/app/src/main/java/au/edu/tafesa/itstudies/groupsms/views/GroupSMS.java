...
public class GroupSMS extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //messageData = new SMSDataModelArray("", 20);
        messageData = new SMSDataModelList("", 20);
        try{
            messageData.addPhoneNumber("0000000000");
            messageData.addPhoneNumber("1111111111");
        }
        catch(SMSDataModelFullException excep){
            System.out.println("You should never see this message!" +
                    "Getting rid of these two numbers would probably be better!");
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_MESSAGE_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                this.messageData = (SMSDataModelList) (data.getSerializableExtra("NEW_PHONE"));
                setSummary();
            }
        }
    }
